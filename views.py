...
class View():
    def __init__(self, root):
        ...
        # Acceso más seguro a los botones de la lista de discos
    ...
    def configurar_ventana(self):
        """Configura título, tamaño, color e icono usando el .env"""
    ...
    def al_buscar(self):
        """El controlador sobreescribirá esta función"""
        pass

    def mostrar(self, nombre, titulo_form=None):
        """Mapeo para cambiar entre pantallas"""
        mapa = {
            "home": "home",
            "lista": "discos",
            "artistas": "artistas",
