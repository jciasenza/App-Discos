...
class ArtistaListView(tk.Frame):
    ...
    def crear_widgets(self):
        ...
        self.entry_buscar = tk.Entry(self.search_frame)
        self.entry_buscar.pack(side="left", padx=5)
        
        self.buscar_var = tk.StringVar()
        self.entry_buscar.configure(textvariable=self.buscar_var)
        ...
        # 4. BOTONES CON COMANDOS ASOCIADOS
    ...
    def on_eliminar(self):
        """Lógica para eliminar el artista seleccionado"""
        id_sel = self.obtener_seleccionado()
        if id_sel:
